...
}	if($_POST['submit'])
{
	 ...
	 $sql = "INSERT INTO regis (picsource,firstName,lastName,gender,LAddress,PAddress,Mob,Email,Aadhaar) VALUES ('$folder','$firstName','$lastName','$gender','$LAddress','$PAddress','$Mob','$Email','$Aadhaar')";
